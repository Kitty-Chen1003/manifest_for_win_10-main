...
from views.change_cl380_by_sub_id import ChangeCL380BySubID


class ChangeCL380ByMainID(QDialog):
    def __init__(self, username, token):
        super().__init__()
        self.username = username
        self.token = token

        self.setWindowTitle("Change CL380 of main table-goodsshipment")
    ...
    def on_confirm(self):
        ...
        if selected_option == "CL380":
            dialog = ChangeCL380BySubID(self.username, self.token, selected_option, selected_ids)
